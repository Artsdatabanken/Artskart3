...
public interface ISearchRepository
{
    ...
    Task<IEnumerable<ObservationListInfoDto>> GetObservationByLocations(ObservationsByLocationRequestDto request, CancellationToken cancellationToken = default);
