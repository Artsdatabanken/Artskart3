...
public interface ISearchService
{
    ...
    Task<IEnumerable<ObservationListInfoDto>> GetObservationsByLocations(ObservationsByLocationRequestDto request,  CancellationToken cancellationToken = default);
