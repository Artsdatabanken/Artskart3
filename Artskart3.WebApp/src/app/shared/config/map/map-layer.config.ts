...
export const MAP_TYPE_OPTIONS: MapTypeOption[] = [
  ...
  { label: 'mapToolbar.mapTypes.landscape', description: 'mapToolbar.mapTypes.svalbard', layerId: 'svalbard' },
  { label: 'mapToolbar.mapTypes.landscape', description: 'mapToolbar.mapTypes.janmayen', layerId: 'janmayen' },
];
