...
namespace Artskart3.Infrastructure.Data
{
    ...
    public virtual DbSet<TempIndexNode1Time2601052127> TempIndexNode1Time2601052127s { get; set; }

    public virtual DbSet<TempIndexNode1Time2601052134> TempIndexNode1Time2601052134s { get; set; }

    public virtual DbSet<TempIndexNode40Time2601131542> TempIndexNode40Time2601131542s { get; set; }

    public virtual DbSet<TempIndexNode40Time2601151351> TempIndexNode40Time2601151351s { get; set; }

    public virtual DbSet<TempIndexNode40Time2601190922> TempIndexNode40Time2601190922s { get; set; }

    public virtual DbSet<TempIndexNode40Time2601191055> TempIndexNode40Time2601191055s { get; set; }

    public virtual DbSet<TempIndexNode40Time2601241602> TempIndexNode40Time2601241602s { get; set; }

    public virtual DbSet<TempIndexNode8Time2601052207> TempIndexNode8Time2601052207s { get; set; }

    public virtual DbSet<ViewArtslisteTilMd> ViewArtslisteTilMds { get; set; }

    public virtual DbSet<ViewExport> ViewExports { get; set; }

    public virtual DbSet<ViewExportPoint> ViewExportPoints { get; set; }

    public virtual DbSet<ViewExportPolygon> ViewExportPolygons { get; set; }

    public virtual DbSet<ViewShapeExport2> ViewShapeExport2s { get; set; }

    public virtual DbSet<ViewShapeExportBlacklist2> ViewShapeExportBlacklist2s { get; set; }

    public virtual DbSet<ViewShapeExportRedlist2> ViewShapeExportRedlist2s { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TempIndexNode1Time2601052127>(entity =>
        {
            entity.HasKey(e => e.ProxyId);

            entity.ToTable("TempIndexNode1Time2601052127");

            entity.Property(e => e.ProxyId).HasMaxLength(150);
        });

        modelBuilder.Entity<TempIndexNode1Time2601052134>(entity =>
        {
            entity.HasKey(e => e.ProxyId);

            entity.ToTable("TempIndexNode1Time2601052134");

            entity.Property(e => e.ProxyId).HasMaxLength(150);
        });

        modelBuilder.Entity<TempIndexNode40Time2601131542>(entity =>
        {
            entity.HasKey(e => e.ProxyId);

            entity.ToTable("TempIndexNode40Time2601131542");

            entity.Property(e => e.ProxyId).HasMaxLength(150);
        });

        modelBuilder.Entity<TempIndexNode40Time2601151351>(entity =>
        {
            entity.HasKey(e => e.ProxyId);

            entity.ToTable("TempIndexNode40Time2601151351");

            entity.Property(e => e.ProxyId).HasMaxLength(150);
        });

        modelBuilder.Entity<TempIndexNode40Time2601190922>(entity =>
        {
            entity.HasKey(e => e.ProxyId);

            entity.ToTable("TempIndexNode40Time2601190922");

            entity.Property(e => e.ProxyId).HasMaxLength(150);
        });

        modelBuilder.Entity<TempIndexNode40Time2601191055>(entity =>
        {
            entity.HasKey(e => e.ProxyId);

            entity.ToTable("TempIndexNode40Time2601191055");

            entity.Property(e => e.ProxyId).HasMaxLength(150);
        });

        modelBuilder.Entity<TempIndexNode40Time2601241602>(entity =>
        {
            entity.HasKey(e => e.ProxyId);

            entity.ToTable("TempIndexNode40Time2601241602");

            entity.Property(e => e.ProxyId).HasMaxLength(150);
        });

        modelBuilder.Entity<TempIndexNode8Time2601052207>(entity =>
        {
            entity.HasKey(e => e.ProxyId);

            entity.ToTable("TempIndexNode8Time2601052207");

            entity.Property(e => e.ProxyId).HasMaxLength(150);
        });

        modelBuilder.Entity<ViewArtslisteTilMd>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("View_ArtslisteTilMD");

            entity.Property(e => e.Grunnlag)
                .HasMaxLength(55)
                .IsUnicode(false);
            entity.Property(e => e.PrefferedPopularname).HasMaxLength(100);
            entity.Property(e => e.Tag).HasMaxLength(50);
            entity.Property(e => e.TagGroup).HasMaxLength(50);
            entity.Property(e => e.TaxonGroupName).HasMaxLength(75);
            entity.Property(e => e.ValidScientificName).HasMaxLength(100);
            entity.Property(e => e.ValidScientificNameAuthorship).HasMaxLength(200);
        });

        modelBuilder.Entity<ViewExport>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("View_Export");
            ...
            entity.Property(e => e.EventTime).HasMaxLength(100);
            entity.Property(e => e.Feeding).HasColumnName("feeding");
            entity.Property(e => e.FieldNumber).HasMaxLength(100);
            entity.Property(e => e.GeoreferenceRemarks).HasMaxLength(50);
            entity.Property(e => e.Habitat).HasMaxLength(2000);
            entity.Property(e => e.IdentifiedBy).HasMaxLength(100);
            ...
            entity.Property(e => e.InstitutionCode).HasMaxLength(100);
            entity.Property(e => e.InstitutionId).HasMaxLength(25);
            entity.Property(e => e.Kategori).HasMaxLength(2);
            entity.Property(e => e.Locality).HasMaxLength(100);
            entity.Property(e => e.LocalityName).HasMaxLength(1000);
            entity.Property(e => e.LookupId).HasMaxLength(50);
            entity.Property(e => e.MeasurementMethod).HasMaxLength(100);
            ...
            entity.Property(e => e.OccurenceId).HasMaxLength(255);
            entity.Property(e => e.OtherCatalogNumbers).HasMaxLength(200);
            entity.Property(e => e.Polularname).HasMaxLength(100);
            entity.Property(e => e.Possiblereproductive).HasColumnName("possiblereproductive");
            entity.Property(e => e.Preparations).HasMaxLength(200);
            entity.Property(e => e.ProxyId).HasMaxLength(255);
            entity.Property(e => e.Rank).HasMaxLength(25);
            entity.Property(e => e.RecordNumber).HasMaxLength(50);
            entity.Property(e => e.RelatedResourceId).HasMaxLength(50);
            entity.Property(e => e.RelationshipOfResource).HasMaxLength(50);
            entity.Property(e => e.Reproductive).HasColumnName("reproductive");
            entity.Property(e => e.ScientificName).HasMaxLength(100);
            entity.Property(e => e.ScientificNameAuthorship).HasMaxLength(200);
            entity.Property(e => e.Sex).HasMaxLength(50);
        ...
        modelBuilder.Entity<ViewExportPoint>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("View_Export_POINT");
        ...
        modelBuilder.Entity<ViewExportPolygon>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("View_Export_POLYGON");
        ...
        modelBuilder.Entity<ViewShapeExport2>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("View_ShapeExport2");

            entity.Property(e => e.Author).HasMaxLength(120);
            entity.Property(e => e.BasisOfRecord).HasMaxLength(20);
            entity.Property(e => e.BoundingBox)
                .HasMaxLength(1)
                .IsUnicode(false);
            entity.Property(e => e.CatalogNumber).HasMaxLength(80);
            entity.Property(e => e.Class).HasMaxLength(40);
            entity.Property(e => e.Cname)
                .HasMaxLength(60)
                .HasColumnName("CName");
            entity.Property(e => e.CollId).HasColumnName("collId");
            entity.Property(e => e.CollectingMethod).HasMaxLength(15);
            entity.Property(e => e.CollectionCode).HasMaxLength(50);
            entity.Property(e => e.Collector).HasMaxLength(120);
            entity.Property(e => e.CollectorNumber).HasMaxLength(36);
            entity.Property(e => e.ContinentOcean)
                .HasMaxLength(1)
                .IsUnicode(false);
            ...
            entity.Property(e => e.CountyOrg).HasMaxLength(25);
            entity.Property(e => e.ElevationKilde)
                .HasMaxLength(1)
                .IsUnicode(false);
            entity.Property(e => e.Family).HasMaxLength(40);
            entity.Property(e => e.FieldNumber).HasMaxLength(12);
            entity.Property(e => e.Genus).HasMaxLength(40);
            entity.Property(e => e.Habitat).HasMaxLength(120);
            entity.Property(e => e.IdentifiedBy).HasMaxLength(100);
            entity.Property(e => e.Iname)
                .HasMaxLength(60)
                .HasColumnName("IName");
            entity.Property(e => e.IndividualCount).HasMaxLength(10);
            entity.Property(e => e.InstId).HasColumnName("instId");
            entity.Property(e => e.InstitutionCode).HasMaxLength(25);
            entity.Property(e => e.Kingdom).HasMaxLength(40);
            entity.Property(e => e.KoordKilde).HasMaxLength(2);
            entity.Property(e => e.Locality).HasMaxLength(100);
            entity.Property(e => e.MaxDepth)
                .HasMaxLength(1)
                .IsUnicode(false);
            entity.Property(e => e.Mgrsfra)
                .HasMaxLength(1)
                .IsUnicode(false)
                .HasColumnName("MGRSfra");
            entity.Property(e => e.Mgrstil)
                .HasMaxLength(1)
                .IsUnicode(false)
                .HasColumnName("MGRStil");
            entity.Property(e => e.MinDepth)
                .HasMaxLength(1)
                .IsUnicode(false);
            entity.Property(e => e.MuniName).HasMaxLength(200);
            entity.Property(e => e.MunicipalityId)
                .HasMaxLength(50)
                .HasColumnName("MunicipalityID");
            entity.Property(e => e.NodeDatabaseId).HasColumnName("NodeDatabaseID");
            entity.Property(e => e.NorskNavn).HasMaxLength(100);
            entity.Property(e => e.Notes).HasMaxLength(120);
            entity.Property(e => e.Okologi)
                .HasMaxLength(1)
                .IsUnicode(false);
            entity.Property(e => e.Order).HasMaxLength(40);
            entity.Property(e => e.Phylum).HasMaxLength(40);
            entity.Property(e => e.PreparationType).HasMaxLength(12);
            entity.Property(e => e.PreviousCatalogNumber).HasMaxLength(15);
            entity.Property(e => e.ProxyId).HasMaxLength(255);
            entity.Property(e => e.RelatedCatalogItem).HasMaxLength(15);
            entity.Property(e => e.RelationshipType).HasMaxLength(15);
            entity.Property(e => e.RelativeAboundance)
                .HasMaxLength(1)
                .IsUnicode(false);
            entity.Property(e => e.Sex).HasMaxLength(20);
            entity.Property(e => e.Species).HasMaxLength(70);
            entity.Property(e => e.StateProvince).HasMaxLength(25);
            entity.Property(e => e.Status).HasMaxLength(2);
            entity.Property(e => e.Subspecies).HasMaxLength(70);
            entity.Property(e => e.Substrat)
                .HasMaxLength(1)
                .IsUnicode(false);
            entity.Property(e => e.TypeStatus).HasMaxLength(12);
            entity.Property(e => e.Url)
                .HasMaxLength(120)
                .HasColumnName("URL");
            entity.Property(e => e.Utm33nord).HasColumnName("UTM33nord");
            entity.Property(e => e.Utm33ost).HasColumnName("UTM33ost");
            entity.Property(e => e.Utmnord).HasColumnName("UTMnord");
            entity.Property(e => e.Utmost).HasColumnName("UTMost");
            entity.Property(e => e.Utmsone)
                .HasMaxLength(3)
                .IsUnicode(false)
                .HasColumnName("UTMsone");
            entity.Property(e => e.VitNavn).HasMaxLength(100);
        });

        modelBuilder.Entity<ViewShapeExportBlacklist2>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("View_ShapeExportBlacklist2");
        ...
        modelBuilder.Entity<ViewShapeExportRedlist2>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("View_ShapeExportRedlist2");
