...
public class LookupEndpointTests : IAsyncLifetime
{
    ...
    /// </summary>
    [Fact]
    public async Task GetSearchDatasets_WithBlankSearch_Returns400()
    {
        var response = await _client.GetAsync("/api/Lookup/Datasets?search=%20");
    ...
    [Fact]
    public async Task GetSearchProjects_Returns200WithJsonArray()
    {
        var response = await _client.GetAsync("/api/Lookup/Projects?search=a&maxCount=10");
    ...
    [Fact]
    public async Task GetSearchProjects_WithMaxCountOutOfRange_Returns400()
    {
        var response = await _client.GetAsync("/api/Lookup/Projects?search=a&maxCount=0");
